...
def is_valid_ismn(ismn_num: str) -> bool:
    try:
        ismn.validate(ismn_num)
...
class ColumnValuesToBeValidIsmn(ColumnMapMetricProvider):
    ...
    def _pandas(self, column, **kwargs):
        return column.apply(lambda x: is_valid_ismn(x))
