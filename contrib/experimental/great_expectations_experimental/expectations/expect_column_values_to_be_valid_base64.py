...
# This method compares a string to the valid base64 code
def is_valid_base64(code: str) -> bool:
    try:
...
class ColumnValuesToBeValidBase64(ColumnMapMetricProvider):

    # This is the id string that will be used to reference your metric.
    condition_metric_name = "column_values.valid_base64"

    # This method implements the core logic for the PandasExecutionEngine
    @column_condition_partial(engine=PandasExecutionEngine)
    def _pandas(self, column, **kwargs):
        return column.apply(lambda x: is_valid_base64(x))
